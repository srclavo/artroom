...
import { Plus_Jakarta_Sans, League_Spartan, DM_Sans, DM_Mono } from 'next/font/google';
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${plusJakarta.variable} ${leagueSpartan.variable} ${dmSans.variable} ${dmMono.variable} antialiased`}>
        <a
          href="#main-content"
